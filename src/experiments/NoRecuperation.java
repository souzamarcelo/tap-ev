...
public class NoRecuperation {
    ...
    private void setFixedParameters(String network){
        ...
        Parameters.resultFileName = Parameters.network + "NO-RECUPERATION";
        ...
        Parameters.eta_in_electric_tank_to_wheel = 0d;
        Parameters.eta_in_electric_well_to_wheel = 0d;
    }
